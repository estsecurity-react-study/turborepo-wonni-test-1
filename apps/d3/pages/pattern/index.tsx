...
import GeneralUpdatePattern from './GeneralUpdatePattern';
...
const campaign: Data[] = [
  { name: '운영체제 최신보안 패치', value: 10 },
  { name: '보안센터 서비스 실행', value: 60 },
  { name: 'Windows 방화벽 사용', value: 40 },
  { name: '윈도우 로그인 패스워드', value: 50 },
  { name: '바이러스 백신 설치 및 실행', value: 30 },
  { name: '기타', value: 70 },
];
  ...
  return (
    <div ref={rootRef} className="grid grid-flow-col grid-rows-2 grid-cols-2 gap-8">
      <div ref={childrenRef}>
        {data.length > 1 ? (
          <>
            <h3>The General Update Pattern of D3.js</h3>
